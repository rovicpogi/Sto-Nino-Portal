...
import { LayoutDashboard, GraduationCap, FileText, User, Home, Bell, Search, ChevronRight } from "lucide-react"
...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar - Removed Learning Management and E-Library */}
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-white border border-gray-200">
                <CardHeader>
                  ...
                  <CardDescription>Your current admission and enrollment status</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
